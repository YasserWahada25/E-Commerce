          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
            {[...Array(8)].map((_, index) => (
              <div key={index} className='card-modern p-6 animate-pulse'>
                <div className='bg-gray-200 h-6 rounded w-3/4 mb-3' />
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                {categories.map((category, index) => (
                  <Link
                    ...
                    className='group'
                  >
                    <div className='card-modern p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-indigo-50'>
                      <div className='flex flex-col'>
                        {/* Category Name */}
                        <h3 className='text-xl font-bold text-gray-900 capitalize mb-2 group-hover:text-indigo-600 transition-colors'>
                          {category.category}
                        </h3>
